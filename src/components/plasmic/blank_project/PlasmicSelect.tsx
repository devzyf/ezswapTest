...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: ArgYLLrqxca/component
...
import * as sty from "./PlasmicSelect.module.css"; // plasmic-import: KLG_AqYkhWj/css

import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: Xg8QjnlUDBQ/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: TaoxgNKaCnR/icon
      ...
      >
        ...
        >
          ...
          <p.PlasmicIcon
            ...
            PlasmicIconType={
              hasVariant(variants, "isOpen", "isOpen") ? Icon3Icon : Icon2Icon
            }
              ...
              {p.renderPlasmicSlot({
                defaultContents: (
                  <React.Fragment>
                    ...
                    <Select__Option
                      className={classNames("__wab_instance", sty.option__zL3T)}
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__ahbFc)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
